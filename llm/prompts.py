...
def build_candidate_prompt(
    ...
    return (
        ...
        "- For URI-valued categories/time periods/vehicle types/SAE levels, prefer BIND(REPLACE(STR(?x), '^.*/', '') AS ?label) instead of inventing label predicates like periodLabel.\n"
        "- Do not use survey:technologyCategoryName unless the variable is explicitly typed as survey:TechnologyCategory.\n"
        ...
        "Q: Compare future demand percentage changes by technology category and quarter.\n"
        "A:\n"
        "[\n"
        ...
        "Q: Show future demand percentage change by vehicle type and quarter.\n"
        "A:\n"
        "[\n"
        ...
        "Q: Which vehicle type and SAE level has the highest autonomous driving percentage?\n"
        "A:\n"
        "[\n"
        ...
        "Q: Show order cancellation responses by semiconductor technology category.\n"
        "A:\n"
        "[\n"
