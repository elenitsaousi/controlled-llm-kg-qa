...
def main() -> None:
    ...
    parser.add_argument("--enable-validated-source-rescue", action="store_true")
    ...
    if args.enable_validated_source_rescue:
        os.environ["INFINEON_ENABLE_VALIDATED_SOURCE_RESCUE"] = "1"
